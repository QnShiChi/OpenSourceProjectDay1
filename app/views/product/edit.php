...
<?php endif; ?>
<form method="POST" action="/PhanDuongQuocNhat/Product/update" enctype="multipart/form-data"
    ...
    <div class="form-group">
        ...
        48 BÀI 2TẠO CƠ SỞ DỮ LIỆU CHO WEBSITE BÁN HÀNG, XÂY DỰNG CHỨC NĂNG HIỂN THỊ/ THÊM/ XÓA/ SỬA
        <input type="hidden" name="existing_image" value="<?php echo $product->image;
                                                            ?>">
        <?php if ($product->image): ?>
            <img src="/PhanDuongQuocNhat/<?php echo $product->image; ?>" alt="Product
...
<a href="/PhanDuongQuocNhat/Product/list" class="btn btn-secondary mt-2">Quay lại danh sách
    sản phẩm</a>
